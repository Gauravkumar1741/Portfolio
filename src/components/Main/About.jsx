        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Gaurav Kumar and I am a frontend developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage="I have been working in web development from 1 year, with a focus on React.js, HTML, CSS, and JavaScript. During this time, I have built applications such as the 'Show Time' ticket booking app and a smart crop recommendation web page, demonstrating my expertise in frontend development. I am dedicated to continuously improving my skills, staying up-to-date with the latest web technologies, and refining my development practices. My passion lies in learning new tools and frameworks to build robust, scalable applications that deliver exceptional user experiences."
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Cricket,Travelling and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> gkmr8851@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
