          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id='about-info-1'
                  defaultMessage="Hi, I'm Gaurav Kumar, a student at Kalinga Institute of Industrial Technology. I consider myself passionate about programming and web development, a journey I embarked on in 2023 when I created my first web page using just HTML and CSS. Since then, my passion for web development has only grown, especially with the possibilities that HTML, CSS, and JavaScript offer. To this day, I still feel the same excitement when building web applications.

I am a self-taught learner, constantly improving my skills and keeping up with the latest technologies and development practices. My internship experience as a web developer has given me the opportunity to work on diverse projects. This experience, along with the courses and internships I've completed, has helped me refine my abilities and deepen my knowledge in this ever-evolving field of web development."
                />
              </p>
